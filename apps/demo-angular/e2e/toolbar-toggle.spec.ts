...
// Toolbar buttons
const linkBtn = 'domternal-toolbar button[aria-label="Link"]';
const imageBtn = 'domternal-toolbar button[aria-label="Insert Image"]';
const emojiBtn = 'domternal-toolbar button[aria-label="Insert Emoji"]';
const highlightBtn = 'domternal-toolbar button[aria-label="Highlight"]';
